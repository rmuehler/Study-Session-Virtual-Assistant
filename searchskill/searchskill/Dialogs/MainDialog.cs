...
using searchskill.Models;
using searchskill.Responses.Main;
using searchskill.Responses.Shared;
using searchskill.Services;

namespace searchskill.Dialogs
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task RouteAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            localeConfig.LuisServices.TryGetValue("searchskill", out var luisService);
            ...
            else
            {
                ...
                switch (intent)
                {
                    case searchskillLuis.Intent.Sample:
                        {
